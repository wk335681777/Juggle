...
type TransformRawData = RawData & { content: string; inputFormat: string };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.TRANSFORM,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<TransformRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as TransformRawData);
watch(
    () => props.data,
    val => {
  ...
  <div class="node-method-form">
    <el-form label-position="top">
      ...
      <el-form-item label="模板内容" required>
        <el-input v-model="nodeData.content"  placeholder="请输入" :rows="13" type="textarea"></el-input>
      </el-form-item>
      <el-form-item>
