...
type ConvertBodyToRawData = RawData & { type: string };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.CONVERT_BODY_TO,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<ConvertBodyToRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as ConvertBodyToRawData);
watch(
    () => props.data,
    val => {
  ...
  <div class="node-method-form">
    <el-form label-position="top">
      ...
      <el-form-item label="Type" required>
        <el-input v-model="nodeData.type"  placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item>
