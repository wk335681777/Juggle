...
type UnMarshalRawData = RawData & { type: string };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.UNMARSHAL,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<UnMarshalRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as UnMarshalRawData);
watch(
    () => props.data,
    val => {
