...
type SetBodyRawData = RawData & { body: string };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.SET_BODY,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<SetBodyRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as SetBodyRawData);
watch(
    () => props.data,
    val => {
