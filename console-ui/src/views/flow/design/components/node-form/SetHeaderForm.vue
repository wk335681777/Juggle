...
type SetHeaderRawData = RawData & { headerName: string; headerValue: string };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.SET_HEADER,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<SetHeaderRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as SetHeaderRawData);
watch(
    () => props.data,
    val => {
...
<template>
  <div class="node-method-form">
    <el-form label-position="top">
      ...
      <el-form-item label="headerName" required>
        <el-input v-model="nodeData.headerName"  placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item label="headerValue" required>
        <el-input v-model="nodeData.headerValue"  placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item>
