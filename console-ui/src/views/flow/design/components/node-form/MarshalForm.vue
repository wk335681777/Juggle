...
type MarshalRawData = RawData & { type: string };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.MARSHAL,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<MarshalRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as MarshalRawData);
watch(
    () => props.data,
    val => {
