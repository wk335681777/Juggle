...
type DynamicRouteRawData = RawData & { dynamicRouteId: string };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.DYNAMIC_ROUTE,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<DynamicRouteRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as DynamicRouteRawData);
watch(
    () => props.data,
    val => {
...
<template>
  <div class="node-method-form">
    <el-form label-position="top">
      ...
      <el-form-item label="DynamicRouteId" required>
        <el-input v-model="nodeData.dynamicRouteId"  placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item>
