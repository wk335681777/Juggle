...
type RecipientListRawData = RawData & { expression: string; parallelProcessing: boolean };
...
function getDefaultData() {
  return {
    ...
    outgoings: [],
    incomings: [],
    elementType: ElementType.RECIPIENT_LIST,
    log: '',
  };
}
...
const props = defineProps({
  data: {
    type: Object as PropType<RecipientListRawData>,
    required: true,
  },
});

const nodeData = ref(getDefaultData() as RecipientListRawData);
watch(
    () => props.data,
    val => {
...
<template>
  <div class="node-method-form">
    <el-form label-position="top">
      ...
      <el-form-item label="Expression" required>
        <el-input v-model="nodeData.expression"  placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item label="ParallelProcessing" required>
        <el-switch v-model="nodeData.parallelProcessing" active-text="是" inactive-text="否" />
      </el-form-item>
      <el-form-item>
